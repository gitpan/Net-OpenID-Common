...
BEGIN {
  $Net::OpenID::Extension::SimpleRegistration::VERSION = '1.13';
}
...
BEGIN {
  $Net::OpenID::Extension::SimpleRegistration::Request::VERSION = '1.13';
}
...
BEGIN {
  $Net::OpenID::Extension::SimpleRegistration::Response::VERSION = '1.13';
}
